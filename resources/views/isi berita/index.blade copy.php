                        ...
                        <div class="header-mobile-wrap">
                            <div class="mbnav edge-padding">
                                <div class="navbar-left">
                                    ...
                                    <div class="mobile-logo-wrap is-image-logo site-branding">
                                        <a href="../../index.html" title="Technology">
                                            <img class="logo-default" data-mode="default" height="60" width="92"
                                                src="../../wp-content/uploads/sites/3/2022/01/logo-t.png"
                                                alt="Technology" loading="lazy" /><img class="logo-dark"
                                                data-mode="dark" height="60" width="92"
                                                src="../../wp-content/uploads/sites/3/2022/01/logo-t.png"
                                ...
                                <div class="navbar-right">
                                    <a href="#" class="mobile-menu-trigger mobile-search-icon"><span
                            ...
                            <div class="mobile-qview">
                                <ul id="menu-mobile-quick-access-1" class="mobile-qview-inner">
                                    <li
                                        ...
                                        <a href="../tech-news/index.html"><span>Tech News</span></a>
                                    </li>
                                    <li
                                        class="menu-item menu-item-type-taxonomy menu-item-object-category current-menu-item menu-item-1698">
                                        <a href="index.html" aria-current="page"><span>Gadget</span></a>
                                    </li>
                                    <li
                                        class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-1699">
                                        <a href="../technology/index.html"><span>Technology</span></a>
                                    </li>
                                    <li
                                        class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-1700">
                                        <a href="../mobile/index.html"><span>Mobile</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="mobile-collapse-inner">
                                    ...
                                    <nav class="mobile-menu-wrap edge-padding">
                                        <ul id="mobile-menu" class="mobile-menu">
                                            ...
                                            <li id="menu-item-1701"
                                                class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-1701">
                                                ...
                                                <ul class="sub-menu">
                                                    <li id="menu-item-1702"
                                                        ...
                                                        <a href="../tech-news/index.html"><span>Tech
                                                                News</span></a>
                                                    </li>
                                                    <li id="menu-item-1703"
                                                        class="menu-item menu-item-type-taxonomy menu-item-object-category current-menu-item menu-item-1703">
                                                        <a href="index.html" aria-current="page"><span>Gadget</span></a>
                                                    </li>
                                            ...
                                            <li id="menu-item-1706"
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li id="menu-item-1708"
                                                        ...
                                                        <a href="../../my-bookmarks/index.html"><span>My
                                                                Bookmarks</span></a>
                                                    </li>
                                                </ul>
                                            </li>
                                    ...
                                    <div class="mobile-collapse-sections edge-padding">
                                        <div class="mobile-login">
                                            <span class="mobile-login-title h6">Have an existing
                                                account?</span>
                                            <a href="../../wp-logincc02.html?redirect_to=https%3A%2F%2Ffoxiz.themeruby.com%2Ftech%2Fcategory%2Fgadget"
                                                class="login-toggle is-login is-btn">Sign In</a>
                                        </div>
                                        <div class="mobile-social-list">
                                            <span class="mobile-social-list-title h6">Follow US</span>
                                            <a class="social-link-facebook" data-title="Facebook" href="#"
                                    ...
                                    <div class="collapse-footer">
                                        ...
                                        <div class="collapse-copyright">
                                            © 2022 Foxiz News Network. Ruby
                                            Design Company. All Rights
                                            Reserved.
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="s-feat">
                                                <div class="featured-lightbox-trigger"
                                                    ...
                                                    <img width="860" height="573"
                                                        src="../wp-content/uploads/sites/3/2021/12/olahraga2.jpg"
