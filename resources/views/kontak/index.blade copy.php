...
<head>
    ...
    <style media="all">
        ...
        @font-face {
            ...
            src: url(//foxiz.themeruby.com/tech/wp-content/plugins/elementor/assets/lib/eicons/css/../fonts/eicons.eot?5.16.0#iefix) format("embedded-opentype"),
                url(//foxiz.themeruby.com/tech/wp-content/plugins/elementor/assets/lib/eicons/css/../fonts/eicons.woff2?5.16.0) format("woff2"),
                url(//foxiz.themeruby.com/tech/wp-content/plugins/elementor/assets/lib/eicons/css/../fonts/eicons.woff?5.16.0) format("woff"),
                url(//foxiz.themeruby.com/tech/wp-content/plugins/elementor/assets/lib/eicons/css/../fonts/eicons.ttf?5.16.0) format("truetype"),
                url(//foxiz.themeruby.com/tech/wp-content/plugins/elementor/assets/lib/eicons/css/../fonts/eicons.svg?5.16.0#eicon) format("svg");
            font-weight: 400;
            font-style: normal;
        }
        ...
        .elementor-element .elementor-widget-container {
            -webkit-transition: background 0.3s, border 0.3s,
                border-radius 0.3s, -webkit-box-shadow 0.3s;
        ...
        .e-transform .elementor-widget-container {
            -webkit-transform: perspective(var(--e-transform-perspective, 0)) rotate(var(--e-transform-rotateZ, 0)) rotateX(var(--e-transform-rotateX, 0)) rotateY(var(--e-transform-rotateY, 0)) translate(var(--e-transform-translate, 0)) translateX(var(--e-transform-translateX, 0)) translateY(var(--e-transform-translateY, 0)) scaleX(calc(var(--e-transform-flipX, 1) * var(--e-transform-scaleX,
                            var(--e-transform-scale, 1)))) scaleY(calc(var(--e-transform-flipY, 1) * var(--e-transform-scaleY,
                            var(--e-transform-scale, 1)))) skewX(var(--e-transform-skewX, 0)) skewY(var(--e-transform-skewY, 0));
            transform: perspective(var(--e-transform-perspective, 0)) rotate(var(--e-transform-rotateZ, 0)) rotateX(var(--e-transform-rotateX, 0)) rotateY(var(--e-transform-rotateY, 0)) translate(var(--e-transform-translate, 0)) translateX(var(--e-transform-translateX, 0)) translateY(var(--e-transform-translateY, 0)) scaleX(calc(var(--e-transform-flipX, 1) * var(--e-transform-scaleX,
                            var(--e-transform-scale, 1)))) scaleY(calc(var(--e-transform-flipY, 1) * var(--e-transform-scaleY,
                            var(--e-transform-scale, 1)))) skewX(var(--e-transform-skewX, 0)) skewY(var(--e-transform-skewY, 0));
        ...
        .elementor-widget-text-path svg text {
            ...
            -o-transition: var(--transition) stroke,
                var(--transition) stroke-width, var(--transition) fill;
                                ...
                                <div 
                                    ...
                                    <div style="text-align:center">
                                        ...
                                        <p style="  
                                                    ...
                                                    font-style: italic;
                                                ">
                                            Karena kami memenuhi kebutuhan pelanggan, waktu tunggu email mungkin lebih lama dari biasanya. Dalam upaya memberi Anda pengalaman pelanggan terbaik, kami mendorong Anda untuk memanfaatkan ponsel kami. Dalam kebanyakan kasus, ini adalah opsi tercepat dan termudah.
                                        </p>
                                    </div>
                                </div>
                                <div class="elementor-element elementor-element-3125def elementor-widget elementor-widget-shortcode"
                                    data-id="3125def" data-element_type="widget" data-widget_type="shortcode.default">
                                    <div class="elementor-widget-container">
                                        <div class="elementor-shortcode">
                                            <div role="form" class="wpcf7" id="wpcf7-f1692-p1481-o1" lang="en-US"
                                                dir="ltr">
                                            ...
                                            @endif
                                                ...
                                                <form action="/kontak" method="post" class="wpcf7-form init" novalidate="novalidate" data-status="init">
                                                    ...
                                                    <div style="display: none;">
                                                      ...
                                                      <input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f1692-p1481-o1" />
                                                    ...
                                                    <span class="wpcf7-form-control-wrap" data-name="your-message">
                                                      ...
                                                      margin-left:150px;" name="judul" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea" aria-invalid="false" placeholder="Judul Pesan" value="{{old('judul')}}">
                                                    </span>
                                                    <span class="wpcf7-form-control-wrap" data-name="your-message">
                                                      <textarea style="width:1000px;
                                                      margin-left:150px;" name="pesan" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea" aria-invalid="false" placeholder="Isi Pesan" value="{{old('pesan')}}">{{old('pesan')}}</textarea>
                                                    </span> @if (Route::has('login'))
                                                    @auth 
                                                    <button style="margin-left:45%;" type="submit" class="is-btn header-element">Kirim</button>
                                                    @else <a href="register_komentar" style="margin-left:45%;" class="is-btn header-element">
                                                      <span>Kirim</span>
                                                    </a> @endauth
                                                     @endif 
                        ...
                        <div class="elementor-column elementor-col-33 elementor-top-column elementor-element elementor-element-75972dc"
                            ...
                            <div class="elementor-widget-wrap elementor-element-populated">
                                <div class="elementor-element elementor-element-d8ea50d elementor-widget elementor-widget-foxiz-heading"
                                    ...
                                    data-widget_type="foxiz-heading.default">
                                    <div class="elementor-widget-container">
                                        <div id="uid_d8ea50d" class="block-h heading-layout-1">
                ...
                <div class="popup-newsletter-shortcode">
                    ...
                    <form id="mc4wp-form-4" class="mc4wp-form mc4wp-form-1616" method="post" data-id="1616"
                        ...
                        <label style="display: none !important">Leave this field empty if you're human:
                            ...
                            value="1675688120" /><input type="hidden" name="_mc4wp_form_id" value="1616" /><input
                            type="hidden" name="_mc4wp_form_element_id" value="mc4wp-form-4" />
                    ...
                    <form name="popup-form" id="popup-form" action="https://foxiz.themeruby.com/tech/wp-login.php"
                        ...
                        <p class="login-submit">
                            <input type="submit" name="wp-submit" id="wp-submit" class="button button-primary"
                                value="Log In" />
                            <input type="hidden" name="redirect_to" value="../contact.html" />
                        </p>
                    </form>
                </div>
