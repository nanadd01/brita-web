                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <div class="pb-3">
                                    <a href='/tambahaturan' class="btn btn-primary">+ Tambah Data</a>
                                </div>
                                <div class="pb-3">
                                <form class="d-flex" action="{{url('aturan')}}" method="get">
