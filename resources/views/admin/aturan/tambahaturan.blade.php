                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Tambah Data Aturan</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                        ...
                        <div class="col-12">
                            <div class="card-box">
                              ...
                              <div class="card-body">
                                ...
                                <form action="/insertaturan" method="POST" enctype="multipart/form-data">
                                  @csrf
                                  <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Aturan</label>
                                    <input type="text" name="aturan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                  </div>
                                  <div class="mb-3">
