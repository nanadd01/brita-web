                        ...
                        <div class="col-12">
                            ...
                            <div class="card-box">
                                <div class="card-body">
                                    ...
                                    <form action="/updateaturan/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                      @csrf
                                      <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Aturan</label>
                                        <input type="text" name="aturan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->aturan}}">
                                      </div>
                                      <div class="mb-3">
                                        ...
                                        <select name="anggota" id="anggota" class="form-control">
                                            <option disabled value="">--Pilih Peran--</option>        
                                                @foreach($role as $aturan)
                                                        <option value="{{ $aturan->id}}" <?php if ($data->anggota == $aturan->id){
                                                            echo 'selected';
                                                        } ?>>{{ $aturan->name}}</option>
                                                    @endforeach
                                            </select>
