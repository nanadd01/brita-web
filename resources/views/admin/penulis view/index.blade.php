...
<head>
    <meta charset="utf-8" />
    <title>Kunjungan Penulis | ATN News - Responsive Bootstrap 4 Admin Dashboard</title>
                ...
                <div class="container-fluid">
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Kunjungan Penulis</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Kunjungan Penulis</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card-box">
                                <h4 class="header-title mb-3">Penulis Dengan Kunjungan Terbanyak</h4>

                                <div class="pb-3">
                                    <form class="d-flex" action="{{url('penulis view')}}" method="get">
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-md-3">Nama Penulis</th>
                                            <th class="col-md-4">Berita Dibuat</th>
                                            <th class="col-md-4">Berita Dikunjungi</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @endif
                                            <td>
                                                <form onsubmit="return confirm('Yakin Ingin Menjadikan Pengguna Ini Sebagai Editor?')" class="d-inline" action="/naikjabatan/{{ $row->id }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <button type="submit" style="color: white;" name="submit"
                                                        class="btn btn-success"><i class="mdi mdi-upload"></i></button>
                                                </form>
    ...
    <div class="right-bar">
        ...
        <div class="slimscroll-menu">
            ...
            <div class="p-4">
                ...
                <a href="https://1.envato.market/XY7j5" class="btn btn-danger btn-block mt-3" target="_blank"><i class="mdi mdi-download mr-1"></i> Unggah Sekarang</a>
            </div>
