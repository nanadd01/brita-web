...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js"
    ...
    <title>
        Inilah 7 Kuliner Indonesia Yang Terkenal Diseluruh Dunia
...
<body
                            ...
                            <div class="navbar-inner">
                                <div class="navbar-left">
                                    <div class="logo-wrap is-image-logo site-branding">
                                        <a href="../../index.html" class="logo" title="Technology">
                                            <img class="logo-default" data-mode="default" height="60" width="92"
                                                src="../../wp-content/uploads/sites/3/2022/01/logo-t.png" srcset="
                                                        https://foxiz.themeruby.com/tech/wp-content/uploads/sites/3/2022/01/logo-t.png  1x,
                                                        https://foxiz.themeruby.com/tech/wp-content/uploads/sites/3/2022/01/logo-tr.png 2x
                                                    " alt="Technology" /><img class="logo-dark" data-mode="dark"
                                                height="60" width="92"
                                                src="../../wp-content/uploads/sites/3/2022/01/logo-t.png" srcset="
                                                        https://foxiz.themeruby.com/tech/wp-content/uploads/sites/3/2022/01/logo-t.png  1x,
                                                        https://foxiz.themeruby.com/tech/wp-content/uploads/sites/3/2022/01/logo-tr.png 2x
                                    ...
                                    <nav id="site-navigation" class="main-menu-wrap" aria-label="main menu">
                                        <ul id="menu-main" class="main-menu rb-menu large-menu" itemscope
                                            ...
                                            <li id="menu-item-1585"
                                                ...
                                                <a href="{{url('dashboard admin')}}"><span>Beranda</span></a>
                    ...
                    <div id="header-mobile" class="header-mobile">
                        <div class="header-mobile-wrap">
                            <div class="mbnav edge-padding">
                                <div class="navbar-left">
                                    <div class="mobile-toggle-wrap"> <a href="#" class="mobile-menu-trigger"> <span
                                                class="burger-icon"><span></span><span></span><span></span></span> </a>
                                    </div>
                                    <div class="mobile-logo-wrap is-image-logo site-branding"> <a href="index.html"
                                            title="Technology"> <img class="logo-default" data-mode="default"
                                                height="60" width="92"
                                                src="wp-content/uploads/sites/3/2022/01/logo-t.png" alt="Technology"
                                                loading="lazy"><img class="logo-dark" data-mode="dark" height="60"
                                                width="92" src="wp-content/uploads/sites/3/2022/01/logo-t.png"
                                                alt="Technology" loading="lazy"> </a></div>
                                </div>
                                <div class="navbar-right"> <a href="#"
                                        class="mobile-menu-trigger mobile-search-icon"><span
                                            class="search-icon-svg"></span></a>
 ...
 c28.961,0,52.522,23.562,52.522,52.523S145.181,168.747,116.22,168.747z" />
                            ...
                            <div class="mobile-qview">
                                <ul id="menu-mobile-quick-access-1" class="mobile-qview-inner">
                                    <li
                                        ...
                                        <a href="category/tech-news/index.html"><span>Tech News</span></a>
                                    </li>
                                    <li
                            ...
                            <div class="mobile-collapse-holder">
                                <div class="mobile-collapse-inner">
                                            ...
                                            <form method="get" action="https://foxiz.themeruby.com/tech/"
                                                ...
                                                <div class="search-form-inner"> <span class="search-icon"><span
                                                        ...
                                                        class="search-text"><input type="text" class="field"
                                                            ...
                                                            class="rbi rbi-cright"></i></span></div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mobile-collapse-sections edge-padding">
                                        ...
                                        <div class="mobile-social-list"> <span
                                                class="mobile-social-list-title h6">Follow US</span> <a
                                                class="social-link-facebook" data-title="Facebook" href="#"
                                                target="_blank" rel="noopener nofollow"><i
                                                    class="rbi rbi-facebook"></i></a><a class="social-link-twitter"
                                                data-title="Twitter" href="#" target="_blank" rel="noopener nofollow"><i
                                                    class="rbi rbi-twitter"></i></a><a class="social-link-youtube"
    ...
    <header class="single-header">
                                    ...
                                    <div class="single-meta">
                                        <div class="smeta-in">
                                            <a class="meta-el meta-avatar" href="../author/technology/index.html"><img
                                                    src="avatar-150x150.jpg"
                                                ...
                                                <div class="p-meta">
                                                    <div class="meta-inner is-meta">
                                                        <span class="meta-el meta-author">
                                                            <a href="../author/technology/index.html">Ugud Budiman</a>
                                                            <span
                                    ...
                                    <div class="s-ct">
                                        ...
                                        <div class="entry-content rbct clearfix is-highlight-shares"
                                            ...
                                            <p class="has-drop-cap">
                                               Selain kaya akan sumber daya alam dan manusia, Indonesia juga kaya akan masakan atau kuliner yang lezat bin mantap bin sedap. Uniknya, cita rasa kuliner tidak hanya cocok di lidah orang sendiri, melainkan juga lidah masyarakat internasional. Tidak heran jika masakan-masakan Indonesia cukup digemari di berbagai negara di dunia. Dari sekian banyaknya jenis kuliner Indonesia yang terkenal di dunia, setidaknya ada 7 kuliner yang paling paling enak sebagaimana yang dikutip dari laman Gramedia berikut ini. 1. Rendang Siapa yang tidak mengenal masakan khas dari Sumatera Barat ini. Daging sapi cincang dimasak dengan bumbu Padang yang lezat. Ada dua cara memasak daging sapi berbumbu ini. Untuk memasang rendang, dibutuhkan minimal 4 jam agar daging rendang berwarna hitam dan bumbunya kering seperti dedak. Rendang dimasak sebentar dengan kuah santan yang masih kental disebut kalio, tekstur kuahnya masih kental dan dagingnya tidak kering. 2. Sate Sate juga merupakan salah satu makanan yang mudah ditemukan di Indonesia. Sate adalah masakan khas Indonesia yang menggunakan daging ayam, sapi, kambing, kelinci atau kerbau sebagai bahannya. Dagingnya dipotong-potong, dibumbui dengan rempah-rempah, lalu dipanggang hingga sempurna. Kemudian, sate disajikan dengan berbagai macam saus mulai dari saus kacang atau kecap. Uniknya, setiap pulau memiliki versi sate yang berbeda. Dari Sate Padang Minangkabau, Sate Madura, Sate Tegal, Sate Klathak, Sate Lilit, Sate Ponorogo, Sate Ambal dan Sate Buntal. Yang membedakan masing-masing sate ini adalah pilihan daging dan kuahnya. Sate sangat cocok dengan nasi atau lontong, acar mentimun dan kerupuk. 3. Nasi Goreng Adakah yang pernah makan nasi goreng? Pasti hampir semua orang tahu masakan ini. Selain nasi goreng yang lezat dan goreng adalah masakan memasak yang mudah. Nasi goreng adalah banyak versi, dengan nasi goreng dari desa, Ijo nasi goreng, beras goreng jawa, nasi goreng, buah buah buah buah, buah buah buah buah, beras buah beras goreng goreng, dll. Biasanya nasi goreng yang biasanya disajikan untuk sarapan atau masakan di malam hari. Bagi para Anda yang sering mencari makan di malam hari, Anda bisa menemukan gerobak nasi goreng dengan aroma yang tak tertahankan. Tak salah jika nasi goreng menjadi sajian kuliner yang juga dinobatkan sebagai hidangan terenak di dunia.
    ...
    <aside id="rb-popup-newsletter" class="popup-newsletter mfp-animation mfp-hide light-scheme" data-display="scroll"
        data-delay="0" data-expired="1" data-offset="2000">
        <div class="popup-newsletter-inner">
            <div class="popup-newsletter-cover">
                <div class="popup-newsletter-cover-holder">
                    <img loading="lazy" decoding="async" class="popup-newsletter-img"
                        src="../wp-content/uploads/sites/3/2022/02/newsletter.jpg" alt="" width="600" height="800" />
                </div>
            </div>
            <div class="popup-newsletter-content">
                <div class="popup-newsletter-header">
                    <h6 class="popup-newsletter-heading h1">
                        Join Us!<span class="popup-newsletter-icon"><svg class="svg-icon svg-newsletter"
 ...
 C286.43,140.75,285.36,138.17,283.5,136.31z" />
                    ...
                    <p class="popup-newsletter-description">
                        Subscribe to our newsletter and never miss our
                        latest news, podcasts etc..
                    </p>
                </div>
                <div class="popup-newsletter-shortcode">
                    ...
                    <form id="mc4wp-form-6" class="mc4wp-form mc4wp-form-1616" method="post" data-id="1616"
                        data-name="form">
                        <div class="mc4wp-form-fields">
                            ...
                            <div class="agree-to-terms">
                                <input name="AGREE_TO_TERMS" type="checkbox" value="1" required="" />I have read and
                                agree to the terms &amp;
                                conditions
                            </div>
                        </div>
                        <label style="display: none !important">Leave this field empty if you're human:
                            ...
                            value="1675688114" /><input type="hidden" name="_mc4wp_form_id" value="1616" /><input
                            type="hidden" name="_mc4wp_form_element_id" value="mc4wp-form-6" />
            ...
            <div class="logo-popup">
                <div class="login-popup-header">
                    <div class="logo-popup-logo">
                        <img loading="lazy" decoding="async" src="../wp-content/uploads/sites/3/2022/02/login.png"
                            alt="" height="200" width="200" />
                    </div>
                    <span class="logo-popup-heading h3">Welcome Back!</span>
                    <p class="logo-popup-description is-meta">
                    ...
                    <form name="popup-form" id="popup-form" action="https://foxiz.themeruby.com/tech/wp-login.php"
                        ...
                        <p class="login-submit">
                            ...
                            <input type="hidden" name="redirect_to"
                                value="../best-fujifilm-cameras-for-every-photographer.html" />
                        </p>
                    </form>
                </div>
